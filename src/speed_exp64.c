...
int main(int argc, char *argv[]) {
  ...
  const double *pgf_coeffs_ptr[PGFDEG] = {
      exp64_pgf1_coeffs, exp64_pgf2_coeffs, exp64_pgf3_coeffs,
      exp64_pgf4_coeffs, exp64_pgf5_coeffs, exp64_pgf6_coeffs,
      exp64_pgf7_coeffs, exp64_pgf8_coeffs, exp64_pgf9_coeffs,
      exp64_pgf10_coeffs};
  const double *cpgf_coeffs_ptr[PGFDEG] = {
      exp64_cpgf1_coeffs, exp64_cpgf2_coeffs, exp64_cpgf3_coeffs,
      exp64_cpgf4_coeffs, exp64_cpgf5_coeffs, exp64_cpgf6_coeffs,
      exp64_cpgf7_coeffs, exp64_cpgf8_coeffs, exp64_cpgf9_coeffs,
      exp64_cpgf10_coeffs};
  const double *mpgf_coeffs_ptr[16] = {
      exp64_mpgfl1m1_coeffs, exp64_mpgfl1m2_coeffs, exp64_mpgfl1m3_coeffs,
      exp64_mpgfl1m4_coeffs, exp64_mpgfl1m5_coeffs, exp64_mpgfl1m6_coeffs,
      exp64_mpgfl1m7_coeffs, exp64_mpgfl1m8_coeffs, exp64_mpgfl2m1_coeffs,
      exp64_mpgfl2m2_coeffs, exp64_mpgfl2m3_coeffs, exp64_mpgfl2m4_coeffs,
      exp64_mpgfl2m5_coeffs, exp64_mpgfl2m6_coeffs, exp64_mpgfl2m7_coeffs,
      exp64_mpgfl2m8_coeffs};
  const int *mpgf_powers_ptr[16] = {
      exp64_mpgfl1m1_powers, exp64_mpgfl1m2_powers, exp64_mpgfl1m3_powers,
      exp64_mpgfl1m4_powers, exp64_mpgfl1m5_powers, exp64_mpgfl1m6_powers,
      exp64_mpgfl1m7_powers, exp64_mpgfl1m8_powers, exp64_mpgfl2m1_powers,
      exp64_mpgfl2m2_powers, exp64_mpgfl2m3_powers, exp64_mpgfl2m4_powers,
      exp64_mpgfl2m5_powers, exp64_mpgfl2m6_powers, exp64_mpgfl2m7_powers,
      exp64_mpgfl2m8_powers};
  const double *arma_b_ptr[ABDEGS] = {exp64_armad1_b, exp64_armad2_b,
                               exp64_armad3_b};
  const double *arma_a_ptr[ABDEGS] = {exp64_armad1_a, exp64_armad2_a,
                               exp64_armad3_a};
  ...
  for (int b = 0; b < n_batches; b++) {
    ...
    t_temp = clock();
    for (int i = 0; i < cur_batch_size; i++)
      exact_filter_64(buffer_in[i], buffer_out_exact[i], h64_exp);
    t_exact += clock() - t_temp;

    // matrix multiplication
    t_temp = clock();
    for (int i = 0; i < cur_batch_size; i++)
      mat_times_vec(buffer_in[i], buffer_out_mat[i], exp64, LEN);
    t_mat += clock() - t_temp;
    for (int i = 0; i < cur_batch_size; i++) {
      for (int j = 0; j < LEN; j++) {
