...
int main(int argc, char *argv[]) {
  ...
  const double *pgf_coeffs_ptr[PGFDEG] = {
      tik64_pgf1_coeffs, tik64_pgf2_coeffs, tik64_pgf3_coeffs,
      tik64_pgf4_coeffs, tik64_pgf5_coeffs, tik64_pgf6_coeffs,
      tik64_pgf7_coeffs, tik64_pgf8_coeffs, tik64_pgf9_coeffs,
      tik64_pgf10_coeffs};
  const double *cpgf_coeffs_ptr[PGFDEG] = {
      tik64_cpgf1_coeffs, tik64_cpgf2_coeffs, tik64_cpgf3_coeffs,
      tik64_cpgf4_coeffs, tik64_cpgf5_coeffs, tik64_cpgf6_coeffs,
      tik64_cpgf7_coeffs, tik64_cpgf8_coeffs, tik64_cpgf9_coeffs,
      tik64_cpgf10_coeffs};
  const double *mpgf_coeffs_ptr[16] = {
      tik64_mpgfl1m1_coeffs, tik64_mpgfl1m2_coeffs, tik64_mpgfl1m3_coeffs,
      tik64_mpgfl1m4_coeffs, tik64_mpgfl1m5_coeffs, tik64_mpgfl1m6_coeffs,
      tik64_mpgfl1m7_coeffs, tik64_mpgfl1m8_coeffs, tik64_mpgfl2m1_coeffs,
      tik64_mpgfl2m2_coeffs, tik64_mpgfl2m3_coeffs, tik64_mpgfl2m4_coeffs,
      tik64_mpgfl2m5_coeffs, tik64_mpgfl2m6_coeffs, tik64_mpgfl2m7_coeffs,
      tik64_mpgfl2m8_coeffs};
  const int *mpgf_powers_ptr[16] = {
      tik64_mpgfl1m1_powers, tik64_mpgfl1m2_powers, tik64_mpgfl1m3_powers,
      tik64_mpgfl1m4_powers, tik64_mpgfl1m5_powers, tik64_mpgfl1m6_powers,
      tik64_mpgfl1m7_powers, tik64_mpgfl1m8_powers, tik64_mpgfl2m1_powers,
      tik64_mpgfl2m2_powers, tik64_mpgfl2m3_powers, tik64_mpgfl2m4_powers,
      tik64_mpgfl2m5_powers, tik64_mpgfl2m6_powers, tik64_mpgfl2m7_powers,
      tik64_mpgfl2m8_powers};
  const double *arma_b_ptr[ABDEGS] = {tik64_armad1_b, tik64_armad2_b,
                               tik64_armad3_b};
  const double *arma_a_ptr[ABDEGS] = {tik64_armad1_a, tik64_armad2_a,
                               tik64_armad3_a};
  ...
  for (int b = 0; b < n_batches; b++) {
    ...
    t_temp = clock();
    for (int i = 0; i < cur_batch_size; i++)
      exact_filter_64(buffer_in[i], buffer_out_exact[i], h64_tik);
    t_exact += clock() - t_temp;

    // matrix multiplication
    t_temp = clock();
    for (int i = 0; i < cur_batch_size; i++)
      mat_times_vec(buffer_in[i], buffer_out_mat[i], tik64, LEN);
    t_mat += clock() - t_temp;
    for (int i = 0; i < cur_batch_size; i++) {
      for (int j = 0; j < LEN; j++) {
