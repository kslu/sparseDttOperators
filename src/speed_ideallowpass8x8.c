...
int main(int argc, char *argv[]) {
  ...
  const int *mpgf_powers_ptr[MPGFDEG * MAXM] = {
      ...
      lp8x8_mpgfl2m8_powers};
  const double *arma_b_ptr[ABDEGS] = {lp8x8_armad1_b, lp8x8_armad2_b, lp8x8_armad3_b};
  const double *arma_a_ptr[ABDEGS] = {lp8x8_armad1_a, lp8x8_armad2_a, lp8x8_armad3_a};
