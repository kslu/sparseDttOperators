...
int main(int argc, char *argv[]) {
  ...
  int n_inputs;
  int firdeg = 10, msdeg = 3, msm = 8, mem = 4;
  ...
  const double *fir_coeffs_ptr[10] = {lp8x8_fir1_coeffs, lp8x8_fir2_coeffs,
                                      lp8x8_fir3_coeffs, lp8x8_fir4_coeffs,
                                      lp8x8_fir5_coeffs, lp8x8_fir6_coeffs,
                                      lp8x8_fir7_coeffs, lp8x8_fir8_coeffs,
                                      lp8x8_fir9_coeffs, lp8x8_fir10_coeffs};
