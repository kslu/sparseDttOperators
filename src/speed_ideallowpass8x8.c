...
int main(int argc, char *argv[]) {
  ...
  const double *pgf_coeffs_ptr[PGFDEG] = {
      lp8x8_pgf1_coeffs, lp8x8_pgf2_coeffs, lp8x8_pgf3_coeffs,
      lp8x8_pgf4_coeffs, lp8x8_pgf5_coeffs, lp8x8_pgf6_coeffs,
      lp8x8_pgf7_coeffs, lp8x8_pgf8_coeffs, lp8x8_pgf9_coeffs,
      lp8x8_pgf10_coeffs};
  const double *cpgf_coeffs_ptr[PGFDEG] = {
      lp8x8_cpgf1_coeffs, lp8x8_cpgf2_coeffs, lp8x8_cpgf3_coeffs,
      lp8x8_cpgf4_coeffs, lp8x8_cpgf5_coeffs, lp8x8_cpgf6_coeffs,
      lp8x8_cpgf7_coeffs, lp8x8_cpgf8_coeffs, lp8x8_cpgf9_coeffs,
      lp8x8_cpgf10_coeffs};
  const double *mpgf_coeffs_ptr[MPGFDEG * MAXM] = {
      lp8x8_mpgfl1m1_coeffs, lp8x8_mpgfl1m2_coeffs, lp8x8_mpgfl1m3_coeffs,
      lp8x8_mpgfl1m4_coeffs, lp8x8_mpgfl1m5_coeffs, lp8x8_mpgfl1m6_coeffs,
      lp8x8_mpgfl1m7_coeffs, lp8x8_mpgfl1m8_coeffs, lp8x8_mpgfl2m1_coeffs,
      lp8x8_mpgfl2m2_coeffs, lp8x8_mpgfl2m3_coeffs, lp8x8_mpgfl2m4_coeffs,
      lp8x8_mpgfl2m5_coeffs, lp8x8_mpgfl2m6_coeffs, lp8x8_mpgfl2m7_coeffs,
      lp8x8_mpgfl2m8_coeffs, lp8x8_mpgfl3m1_coeffs, lp8x8_mpgfl3m2_coeffs,
      lp8x8_mpgfl3m3_coeffs, lp8x8_mpgfl3m4_coeffs, lp8x8_mpgfl3m5_coeffs,
      lp8x8_mpgfl3m6_coeffs, lp8x8_mpgfl3m7_coeffs, lp8x8_mpgfl3m8_coeffs};
  const int *mpgf_powers_ptr[MPGFDEG * MAXM] = {
      lp8x8_mpgfl1m1_powers, lp8x8_mpgfl1m2_powers, lp8x8_mpgfl1m3_powers,
      lp8x8_mpgfl1m4_powers, lp8x8_mpgfl1m5_powers, lp8x8_mpgfl1m6_powers,
      lp8x8_mpgfl1m7_powers, lp8x8_mpgfl1m8_powers, lp8x8_mpgfl2m1_powers,
      lp8x8_mpgfl2m2_powers, lp8x8_mpgfl2m3_powers, lp8x8_mpgfl2m4_powers,
      lp8x8_mpgfl2m5_powers, lp8x8_mpgfl2m6_powers, lp8x8_mpgfl2m7_powers,
      lp8x8_mpgfl2m8_powers, lp8x8_mpgfl3m1_powers, lp8x8_mpgfl3m2_powers,
      lp8x8_mpgfl3m3_powers, lp8x8_mpgfl3m4_powers, lp8x8_mpgfl3m5_powers,
      lp8x8_mpgfl3m6_powers, lp8x8_mpgfl3m7_powers, lp8x8_mpgfl3m8_powers};
  const *arma_b_ptr[ABDEGS] = {lp8x8_armad1_b, lp8x8_armad2_b, lp8x8_armad3_b};
  const *arma_a_ptr[ABDEGS] = {lp8x8_armad1_a, lp8x8_armad2_a, lp8x8_armad3_a};
  ...
  for (int b = 0; b < n_batches; b++) {
    ...
    t_temp = clock();
    for (int i = 0; i < cur_batch_size; i++)
      exact_filter_8x8(buffer_in[i], buffer_out_exact[i], h8x8_lp);
    t_exact += clock() - t_temp;

    // matrix multiplication
    t_temp = clock();
    for (int i = 0; i < cur_batch_size; i++)
      mat_times_vec(buffer_in[i], buffer_out_mat[i], lp8x8, LEN);
    t_mat += clock() - t_temp;
    for (int i = 0; i < cur_batch_size; i++) {
      for (int j = 0; j < LEN; j++) {
    ...
    for (int ord = 1; ord <= PGFDEG; ord++) {
      ...
      for (int i = 0; i < cur_batch_size; i++)
        chebyshev_gf(buffer_in[i], buffer_out_cpgf[ord - 1][i], LEN, ord,
                     cpgf_coeffs_ptr[ord - 1], NE_LDD8X8, MEV_LDD8X8, Ldd8x8_a,
                     Ldd8x8_w);
      ...
      for (int it = 1; it <= NITS; it++) {
        ...
        for (int i = 0; i < cur_batch_size; i++)
          armagf_cg(buffer_in[i], buffer_out_arma[ind][i], LEN, it, kbs[d],
                    arma_b_ptr[d], kas[d], arma_a_ptr[d], NE_LDD8X8, Ldd8x8_a,
                    Ldd8x8_w);
