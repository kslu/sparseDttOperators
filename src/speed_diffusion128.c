...
int main(int argc, char *argv[]) {
  ...
  const double *cpgf_coeffs_ptr[PGFDEG] = {
      diff128_cpgf1_coeffs, diff128_cpgf2_coeffs, diff128_cpgf3_coeffs,
      diff128_cpgf4_coeffs, diff128_cpgf5_coeffs, diff128_cpgf6_coeffs,
      diff128_cpgf7_coeffs, diff128_cpgf8_coeffs, diff128_cpgf9_coeffs,
      diff128_cpgf10_coeffs};
  ...
  const int *mpgf_powers_ptr[MPGFDEG * MAXM] = {
      ...
      diff128_mpgfl2m8_powers};
  const double *arma_b_ptr[ABDEGS] = {diff128_armad1_b, diff128_armad2_b,
                               diff128_armad3_b};
  const double *arma_a_ptr[ABDEGS] = {diff128_armad1_a, diff128_armad2_a,
                               diff128_armad3_a};
