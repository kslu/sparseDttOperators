...
int main(int argc, char *argv[]) {
  ...
  const int *mpgf_powers_ptr[MPGFDEG * MAXM] = {
      ...
      diff32_mpgfl2m8_powers};
  const double *arma_b_ptr[ABDEGS] = {diff32_armad1_b, diff32_armad2_b,
                               diff32_armad3_b};
  const double *arma_a_ptr[ABDEGS] = {diff32_armad1_a, diff32_armad2_a,
                               diff32_armad3_a};
