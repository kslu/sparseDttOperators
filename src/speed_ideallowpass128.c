...
int main(int argc, char *argv[]) {
  ...
  const int *mpgf_powers_ptr[MPGFDEG * MAXM] = {
      ...
      lp128_mpgfl2m8_powers};
  const double *arma_b_ptr[ABDEGS] = {lp128_armad1_b, lp128_armad2_b, lp128_armad3_b};
  const double *arma_a_ptr[ABDEGS] = {lp128_armad1_a, lp128_armad2_a, lp128_armad3_a};
