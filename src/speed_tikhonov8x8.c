...
int main(int argc, char *argv[]) {
  ...
  const double *fir_coeffs_ptr[10] = {tik8x8_fir1_coeffs, tik8x8_fir2_coeffs,
                                      tik8x8_fir3_coeffs, tik8x8_fir4_coeffs,
                                      tik8x8_fir5_coeffs, tik8x8_fir6_coeffs,
                                      tik8x8_fir7_coeffs, tik8x8_fir8_coeffs,
                                      tik8x8_fir9_coeffs, tik8x8_fir10_coeffs};
