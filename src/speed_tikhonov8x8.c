...
int main(int argc, char *argv[]) {
  ...
  const double *pgf_coeffs_ptr[PGFDEG] = {
      tik8x8_pgf1_coeffs, tik8x8_pgf2_coeffs, tik8x8_pgf3_coeffs,
      tik8x8_pgf4_coeffs, tik8x8_pgf5_coeffs, tik8x8_pgf6_coeffs,
      tik8x8_pgf7_coeffs, tik8x8_pgf8_coeffs, tik8x8_pgf9_coeffs,
      tik8x8_pgf10_coeffs};
  const double *cpgf_coeffs_ptr[PGFDEG] = {
      tik8x8_cpgf1_coeffs, tik8x8_cpgf2_coeffs, tik8x8_cpgf3_coeffs,
      tik8x8_cpgf4_coeffs, tik8x8_cpgf5_coeffs, tik8x8_cpgf6_coeffs,
      tik8x8_cpgf7_coeffs, tik8x8_cpgf8_coeffs, tik8x8_cpgf9_coeffs,
      tik8x8_cpgf10_coeffs};
  ...
  const int *mpgf_powers_ptr[MPGFDEG * MAXM] = {
      ...
      tik8x8_mpgfl2m8_powers};
  const double *arma_b_ptr[ABDEGS] = {tik8x8_armad1_b, tik8x8_armad2_b,
                               tik8x8_armad3_b};
  const double *arma_a_ptr[ABDEGS] = {tik8x8_armad1_a, tik8x8_armad2_a,
                               tik8x8_armad3_a};
  ...
  for (int b = 0; b < n_batches; b++) {
    ...
    t_temp = clock();
    for (int i = 0; i < cur_batch_size; i++)
      mat_times_vec(buffer_in[i], buffer_out_mat[i], tik8x8, LEN);
    t_mat += clock() - t_temp;
    for (int i = 0; i < cur_batch_size; i++) {
      for (int j = 0; j < LEN; j++) {
