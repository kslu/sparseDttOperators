...
int main(int argc, char *argv[]) {
  ...
  const int *mpgf_powers_ptr[MPGFDEG * MAXM] = {
      ...
      tik4x4_mpgfl2m8_powers};
  const double *arma_b_ptr[ABDEGS] = {tik4x4_armad1_b, tik4x4_armad2_b,
                               tik4x4_armad3_b};
  const double *arma_a_ptr[ABDEGS] = {tik4x4_armad1_a, tik4x4_armad2_a,
                               tik4x4_armad3_a};
