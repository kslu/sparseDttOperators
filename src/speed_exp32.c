...
int main(int argc, char *argv[]) {
  ...
  const double *fir_coeffs_ptr[10] = {exp32_fir1_coeffs, exp32_fir2_coeffs,
                                      exp32_fir3_coeffs, exp32_fir4_coeffs,
                                      exp32_fir5_coeffs, exp32_fir6_coeffs,
                                      exp32_fir7_coeffs, exp32_fir8_coeffs,
                                      exp32_fir9_coeffs, exp32_fir10_coeffs};
