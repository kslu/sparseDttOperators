...
int main(int argc, char *argv[]) {
  ...
  const double *pgf_coeffs_ptr[PGFDEG] = {
      ...
      exp32_pgf4_coeffs, exp32_pgf5_coeffs, exp32_pgf6_coeffs,
      exp32_pgf7_coeffs, exp32_pgf8_coeffs, exp32_pgf9_coeffs,
      exp32_pgf10_coeffs};
  const double *cpgf_coeffs_ptr[PGFDEG] = {
      exp32_cpgf1_coeffs, exp32_cpgf2_coeffs, exp32_cpgf3_coeffs,
