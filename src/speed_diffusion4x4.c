...
int main(int argc, char *argv[]) {
  ...
  const double *mupgf_coeffs_ptr[(MPDEG - 1) * MAXM] = {
      diff4x4_mupgf_m2l1_coeffs, diff4x4_mupgf_m2l2_coeffs,
      diff4x4_mupgf_m2l3_coeffs, diff4x4_mupgf_m2l4_coeffs,
      diff4x4_mupgf_m2l5_coeffs, diff4x4_mupgf_m2l6_coeffs,
      diff4x4_mupgf_m3l1_coeffs, diff4x4_mupgf_m3l2_coeffs,
      diff4x4_mupgf_m3l3_coeffs, diff4x4_mupgf_m3l4_coeffs,
      diff4x4_mupgf_m3l5_coeffs, diff4x4_mupgf_m3l6_coeffs};
