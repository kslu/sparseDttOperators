...
int main(int argc, char *argv[]) {
  ...
  for (int b = 0; b < n_batches; b++) {
    ...
    const double *fir_coeffs_ptr[10] = {
        tik128_fir1_coeffs, tik128_fir2_coeffs, tik128_fir3_coeffs,
        tik128_fir4_coeffs, tik128_fir5_coeffs, tik128_fir6_coeffs,
        tik128_fir7_coeffs, tik128_fir8_coeffs, tik128_fir9_coeffs,
        tik128_fir10_coeffs};
