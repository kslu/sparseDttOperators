...
int main(int argc, char *argv[]) {
  ...
  const double *mupgf_coeffs_ptr[(MPDEG - 1) * MAXM] = {
      lp32_mupgf_m2l1_coeffs, lp32_mupgf_m2l2_coeffs, lp32_mupgf_m2l3_coeffs,
      lp32_mupgf_m2l4_coeffs, lp32_mupgf_m2l5_coeffs, lp32_mupgf_m2l6_coeffs,
      lp32_mupgf_m3l1_coeffs, lp32_mupgf_m3l2_coeffs, lp32_mupgf_m3l3_coeffs,
      lp32_mupgf_m3l4_coeffs, lp32_mupgf_m3l5_coeffs, lp32_mupgf_m3l6_coeffs};
