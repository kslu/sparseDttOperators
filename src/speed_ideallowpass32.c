...
int main(int argc, char *argv[]) {
  ...
  const int *mpgf_powers_ptr[MPGFDEG * MAXM] = {
      ...
      lp32_mpgfl2m8_powers};
  const double *arma_b_ptr[ABDEGS] = {lp32_armad1_b, lp32_armad2_b, lp32_armad3_b};
  const double *arma_a_ptr[ABDEGS] = {lp32_armad1_a, lp32_armad2_a, lp32_armad3_a};
