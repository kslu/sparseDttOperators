...
int main(int argc, char *argv[]) {
  ...
  const double *cpgf_coeffs_ptr[PGFDEG] = {
      diff8x8_cpgf1_coeffs, diff8x8_cpgf2_coeffs, diff8x8_cpgf3_coeffs,
      diff8x8_cpgf4_coeffs, diff8x8_cpgf5_coeffs, diff8x8_cpgf6_coeffs,
      diff8x8_cpgf7_coeffs, diff8x8_cpgf8_coeffs, diff8x8_cpgf9_coeffs,
      diff8x8_cpgf10_coeffs};
  ...
  const int *mpgf_powers_ptr[MPGFDEG * MAXM] = {
      ...
      diff8x8_mpgfl2m8_powers};
  const double *arma_b_ptr[ABDEGS] = {diff8x8_armad1_b, diff8x8_armad2_b,
                               diff8x8_armad3_b};
  const double *arma_a_ptr[ABDEGS] = {diff8x8_armad1_a, diff8x8_armad2_a,
                               diff8x8_armad3_a};
