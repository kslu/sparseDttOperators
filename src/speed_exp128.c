...
int main(int argc, char *argv[]) {
  ...
  for (int b = 0; b < n_batches; b++) {
    ...
    const double *fir_coeffs_ptr[10] = {
        exp128_fir1_coeffs, exp128_fir2_coeffs, exp128_fir3_coeffs,
        exp128_fir4_coeffs, exp128_fir5_coeffs, exp128_fir6_coeffs,
        exp128_fir7_coeffs, exp128_fir8_coeffs, exp128_fir9_coeffs,
        exp128_fir10_coeffs};
