...
int main(int argc, char *argv[]) {
  ...
  const int *mpgf_powers_ptr[MPGFDEG * MAXM] = {
      ...
      exp128_mpgfl2m8_powers};
  const double *arma_b_ptr[ABDEGS] = {exp128_armad1_b, exp128_armad2_b,
                               exp128_armad3_b};
  const double *arma_a_ptr[ABDEGS] = {exp128_armad1_a, exp128_armad2_a,
                               exp128_armad3_a};
